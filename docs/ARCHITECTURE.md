...
| `lower-storey-presentation.js` | Separate builder instances and ghost-material lifecycle for physical context below the active construction floor. | Picking, game-state mutation, or changing active-floor materials. |

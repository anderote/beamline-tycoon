...
- **Water Supply Pipe** (blue/green/red) — rigid cold supply, lukewarm transfer, or hot return
...
same forgiving quarter-tile construction rules. Their standard service datums
let them follow the same plan route; cold and hot rigid water deliberately
share one elevation and separate laterally as a twin. Co-located supports
consolidate into one multi-level rack, but every line remains an independent
network.
Cold water is blue, lukewarm water is green, and hot water is red on
...
then terminates and restarts the line on its two ports. Cryo, cold/lukewarm/hot rigid
...
| Water Supply Pipe | Capacity/rejection (kW), circuit | cold, lukewarm, or hot service |

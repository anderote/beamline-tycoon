...
test('camera motion selects the cheap render path and defers shadow refreshes', () => {
  ...
  assert.match(animate,
    /const cameraMoving = this\._viewRotating \|\| this\._snapping \|\| this\._focusing[\s\S]*this\._cameraMotionUntilMs;/,
    'animated and pointer-driven camera movement share one motion signal');
  assert.match(animate,

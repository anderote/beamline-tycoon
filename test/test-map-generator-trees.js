...
test('tree clumps land inside dark blobs', () => {
  // Blob centers on the long col axis so both fall inside the narrow map.
  // Dark blob in the west half, bright blob in the east half.
  const blobs = [blob(-25, 0, -0.8, 6), blob(25, 0, +0.6, 6)];

  ...
  cryoTransfer: Object.freeze({
    ...
    requirements: Object.freeze([
      Object.freeze({
        ...
        missing: 'Build Helium Recovery/Storage, or use a sealed Cryocooler.',
        raw: params => positive(params.storageCapacityL) > 0,
        solved: flow => positive(flow?.storageCapacityL) > 0,
      }),
      Object.freeze({
        ...
        missing: 'Build a 4 K/2 K Cold Box, or use a sealed Cryocooler.',
      ...
      Object.freeze({
        ...
        missing: 'Build a Helium Compressor, or use a sealed Cryocooler.',
        raw: params => positive(params.heatRejectionCapacityW) > 0,
        solved: flow => positive(flow?.heatRejectionCapacityW) > 0,
        connectedHint: 'Connected, but it is not ready: power it and give a Helium Compressor working Cooling Water.',
      }),
    ]),

...
export const MATERIALS = {
  ...
  wall_office:         makeMat('wall_office.png',         { roughness: 0.86, metalness: 0.0 }),
  wall_hallway:        makeMat('wall_hallway.png',        { roughness: 0.82, metalness: 0.0 }),
  wall_lab:            makeMat('wall_lab.png',            { roughness: 0.55, metalness: 0.0 }),
  ceiling_acoustic_tile: makeMat('ceiling_acoustic_tile.png', { roughness: 0.92, metalness: 0.0 }),
  ceiling_highbay:     makeMat('ceiling_highbay.png',     { roughness: 0.68, metalness: 0.25 }),
  ...
  wall_exterior_stucco: makeMat('wall_exterior_stucco.png', { roughness: 0.95, metalness: 0.0 }),
  wall_exterior_metal: makeMat('wall_exterior_metal.png', { roughness: 0.55, metalness: 0.45 }),
  wall_exterior_precast: makeMat('wall_exterior_precast.png', { roughness: 0.9, metalness: 0.0 }),
  ...
  tile_hardwood_maple:   makeMat('tile_hardwood_maple.png',   { roughness: 0.7, metalness: 0.0 }),
  tile_hardwood_walnut:  makeMat('tile_hardwood_walnut.png',  { roughness: 0.7, metalness: 0.0 }),
  tile_hardwood_herringbone_oak: makeMat('tile_hardwood_herringbone_oak.png', { roughness: 0.7, metalness: 0.0 }),
  tile_hardwood_herringbone_walnut: makeMat('tile_hardwood_herringbone_walnut.png', { roughness: 0.7, metalness: 0.0 }),
  tile_carpet_plain:     makeMat('tile_carpet_plain.png',     { roughness: 0.98, metalness: 0.0 }),
  tile_carpet_berber:    makeMat('tile_carpet_berber.png',    { roughness: 0.98, metalness: 0.0 }),
  tile_carpet_diamond:   makeMat('tile_carpet_diamond.png',   { roughness: 0.95, metalness: 0.0 }),
  tile_carpet_tile:      makeMat('tile_carpet_tile.png',      { roughness: 0.98, metalness: 0.0 }),
  tile_vinyl_speckle:   makeMat('tile_vinyl_speckle.png',   { roughness: 0.72, metalness: 0.0 }),
  tile_linoleum_marbled: makeMat('tile_linoleum_marbled.png', { roughness: 0.78, metalness: 0.0 }),
  tile_cork:             makeMat('tile_cork.png',             { roughness: 0.88, metalness: 0.0 }),
  tile_terrazzo:         makeMat('tile_terrazzo.png',         { roughness: 0.52, metalness: 0.0 }),
  tile_ceramic_square:   makeMat('tile_ceramic_square.png',   { roughness: 0.42, metalness: 0.0 }),
  tile_rubber_coin:      makeMat('tile_rubber_coin.png',      { roughness: 0.96, metalness: 0.0 }),
  tile_rubber_speckle:   makeMat('tile_rubber_speckle.png',   { roughness: 0.96, metalness: 0.0 }),

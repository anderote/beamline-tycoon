// Canonical browser mirror consumed by the Pyodide worker and its sync test.
// Keep paths relative to the application's public base URL.

export const PY_PHYSICS_MODULES = Object.freeze([

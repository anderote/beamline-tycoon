...
export class UtilityLineTool extends Tool {
  ...
  _cableWorld(e, ctx) {
    ...
    const ctrl = ctx.input.utilityLineController;
    // Every utility follows the cursor's line of sight on its own working
    // plane. Terrain remains relevant to hover/tooltips below, but never moves
    // a line away from the screen position where the player aimed it.

...
export const ZONE_FURNISHINGS = {
  // RF Lab furnishings
  rfWorkbench:      { id: 'rfWorkbench',      name: 'RF Workbench',       zoneType: 'rfLab',       cost: 50,   spriteColor: 0xbb9944, gridW: 4, gridH: 2, spriteKey: 'rfWorkbench',      effects: { zoneOutput: 0.03 } },
  ...
  signalGenerator:  { id: 'signalGenerator',   name: 'Signal Generator',   zoneType: 'rfLab',       cost: 200,  spriteColor: 0xcc6644, gridW: 1, gridH: 1, spriteKey: 'signalGenerator',  effects: { zoneOutput: 0.06 } },
  spectrumAnalyzer: { id: 'spectrumAnalyzer',  name: 'Spectrum Analyzer',  zoneType: 'rfLab',       cost: 350,  spriteColor: 0x4488cc, gridW: 1, gridH: 1, spriteKey: 'spectrumAnalyzer', effects: { zoneOutput: 0.08 } },
  networkAnalyzer:  { id: 'networkAnalyzer',   name: 'Network Analyzer',   zoneType: 'rfLab',       cost: 500,  spriteColor: 0x8844cc, gridW: 1, gridH: 1, spriteKey: 'networkAnalyzer',  effects: { zoneOutput: 0.10 } },
  ...
  heatExchanger:    { id: 'heatExchanger',     name: 'Heat Exchanger',     zoneType: 'coolingLab',  cost: 150,  spriteColor: 0x4499aa, gridW: 3, gridH: 2, spriteKey: 'heatExchanger',    effects: { zoneOutput: 0.06 } },
  pipeRack:         { id: 'pipeRack',          name: 'Pipe Rack',          zoneType: 'coolingLab',  cost: 40,   spriteColor: 0x667788, gridW: 1, gridH: 3, spriteKey: 'pipeRack',         effects: { zoneOutput: 0.02 } },
  chillerUnit:      { id: 'chillerUnit',       name: 'Chiller Unit',       zoneType: 'coolingLab',  cost: 300,  spriteColor: 0x2288aa, gridW: 4, gridH: 3, spriteKey: 'chillerUnit',      effects: { zoneOutput: 0.12 } },
  ...
  testChamber:      { id: 'testChamber',       name: 'Test Chamber',       zoneType: 'vacuumLab',   cost: 200,  spriteColor: 0x8855bb, gridW: 3, gridH: 3, spriteKey: 'testChamber',      effects: { zoneOutput: 0.08 } },
  leakDetector:     { id: 'leakDetector',      name: 'Leak Detector',      zoneType: 'vacuumLab',   cost: 180,  spriteColor: 0x6644aa, gridW: 2, gridH: 1, spriteKey: 'leakDetector',     effects: { zoneOutput: 0.06 } },
  ...
  gasManifold:      { id: 'gasManifold',       name: 'Gas Manifold',       zoneType: 'vacuumLab',   cost: 120,  spriteColor: 0x7755aa, gridW: 3, gridH: 1, spriteKey: 'gasManifold',      effects: { zoneOutput: 0.04 } },
  rga:              { id: 'rga',               name: 'Residual Gas Analyzer', zoneType: 'vacuumLab', cost: 400,  spriteColor: 0xaa77dd, gridW: 1, gridH: 2, spriteKey: 'rga',              effects: { zoneOutput: 0.10 } },

  // Office Space furnishings
  desk:             { id: 'desk',              name: 'Desk',               zoneType: 'officeSpace', cost: 30,   spriteColor: 0x5577aa, gridW: 3, gridH: 2, spriteKey: 'desk',             effects: { morale: 1 } },
  ...
  whiteboard:       { id: 'whiteboard',        name: 'Whiteboard',         zoneType: 'officeSpace', cost: 25,   spriteColor: 0xddddee, gridW: 3, gridH: 1, spriteKey: 'whiteboard',       effects: { research: 0.02 } },
  ...
  monitorBank:      { id: 'monitorBank',       name: 'Monitor Bank',       zoneType: 'controlRoom', cost: 150,  spriteColor: 0x44bb66, gridW: 4, gridH: 2, spriteKey: 'monitorBank',      effects: { zoneOutput: 0.06 } },
  serverRack:       { id: 'serverRack',        name: 'Server Rack',        zoneType: 'controlRoom', cost: 250,  spriteColor: 0x338855, gridW: 1, gridH: 2, spriteKey: 'serverRack',       effects: { zoneOutput: 0.08, research: 0.03 } },
  operatorConsole:  { id: 'operatorConsole',   name: 'Operator Console',   zoneType: 'controlRoom', cost: 200,  spriteColor: 0x55cc77, gridW: 3, gridH: 2, spriteKey: 'operatorConsole',  effects: { zoneOutput: 0.07 } },
  ...
  lathe:            { id: 'lathe',             name: 'Lathe',              zoneType: 'machineShop', cost: 120,  spriteColor: 0x997755, gridW: 1, gridH: 4, spriteKey: 'lathe',            effects: { zoneOutput: 0.05 } },
  ...
  cncMill:          { id: 'cncMill',           name: 'CNC Mill',           zoneType: 'machineShop', cost: 350,  spriteColor: 0x998877, gridW: 3, gridH: 2, spriteKey: 'cncMill',          effects: { zoneOutput: 0.10 } },
  assemblyCrane:    { id: 'assemblyCrane',     name: 'Assembly Crane',     zoneType: 'machineShop', cost: 400,  spriteColor: 0xddaa44, gridW: 4, gridH: 4, spriteKey: 'assemblyCrane',    effects: { zoneOutput: 0.12 } },

  // Optics Lab furnishings
  opticalTable:     { id: 'opticalTable',      name: 'Optical Table',           zoneType: 'opticsLab', cost: 250,  spriteColor: 0x44aacc, gridW: 4, gridH: 2, spriteKey: 'opticalTable',     effects: { zoneOutput: 0.08 } },
  laserAlignment:   { id: 'laserAlignment',    name: 'Laser Alignment System',  zoneType: 'opticsLab', cost: 400,  spriteColor: 0xcc4444, gridW: 4, gridH: 1, spriteKey: 'laserAlignment',   effects: { zoneOutput: 0.10, beamPhysics: { emittanceReduction: 0.02 } } },
  ...
  wireScannerBench: { id: 'wireScannerBench',  name: 'Wire Scanner Bench',      zoneType: 'diagnosticsLab', cost: 200,  spriteColor: 0x888888, gridW: 4, gridH: 2, spriteKey: 'wireScannerBench', effects: { zoneOutput: 0.06 } },
  bpmTestFixture:   { id: 'bpmTestFixture',    name: 'BPM Test Fixture',        zoneType: 'diagnosticsLab', cost: 300,  spriteColor: 0xcccc44, gridW: 2, gridH: 2, spriteKey: 'bpmTestFixture',   effects: { zoneOutput: 0.08 } },
  daqRack:          { id: 'daqRack',           name: 'DAQ Rack',                zoneType: 'diagnosticsLab', cost: 250,  spriteColor: 0x44cc44, gridW: 1, gridH: 2, spriteKey: 'daqRack',          effects: { zoneOutput: 0.07, research: 0.02 } },
  serverCluster:    { id: 'serverCluster',     name: 'Server Cluster',          zoneType: 'diagnosticsLab', cost: 500,  spriteColor: 0x448844, gridW: 3, gridH: 2, spriteKey: 'serverCluster',    effects: { research: 0.08 } },
  ...
  servingCounter:   { id: 'servingCounter',    name: 'Serving Counter',    zoneType: 'cafeteria',   cost: 80,   spriteColor: 0x999999, gridW: 4, gridH: 1, spriteKey: 'servingCounter',   effects: { morale: 3 } },
  vendingMachine:   { id: 'vendingMachine',    name: 'Vending Machine',    zoneType: 'cafeteria',   cost: 40,   spriteColor: 0x4488aa, gridW: 1, gridH: 1, spriteKey: 'vendingMachine',   effects: { morale: 1 } },
  ...
  conferenceTable:  { id: 'conferenceTable',   name: 'Conference Table',   zoneType: 'meetingRoom', cost: 60,   spriteColor: 0x775533, gridW: 4, gridH: 2, spriteKey: 'conferenceTable',  effects: { morale: 1, research: 0.02 } },
  projector:        { id: 'projector',          name: 'Projector',          zoneType: 'meetingRoom', cost: 120,  spriteColor: 0x444444, gridW: 1, gridH: 1, spriteKey: 'projector',        effects: { research: 0.04 } },
  ...
  whiteboardLarge:  { id: 'whiteboardLarge',    name: 'Large Whiteboard',   zoneType: 'meetingRoom', cost: 35,   spriteColor: 0xeeeeee, gridW: 3, gridH: 1, spriteKey: 'whiteboardLarge',  effects: { research: 0.03 } },

  // Maintenance furnishings
  toolChest:        { id: 'toolChest',         name: 'Tool Chest',         zoneType: 'maintenance', cost: 50,   spriteColor: 0xbb7744, gridW: 2, gridH: 1, spriteKey: 'toolChest',        effects: { zoneOutput: 0.03 } },
  partsShelf:       { id: 'partsShelf',        name: 'Parts Shelf',        zoneType: 'maintenance', cost: 35,   spriteColor: 0xaa6633, gridW: 4, gridH: 1, spriteKey: 'partsShelf',       effects: { zoneOutput: 0.02 } },
  workCart:         { id: 'workCart',           name: 'Work Cart',          zoneType: 'maintenance', cost: 25,   spriteColor: 0xcc8855, gridW: 2, gridH: 1, spriteKey: 'workCart',         effects: { zoneOutput: 0.01 } },
  craneHoist:       { id: 'craneHoist',        name: 'Crane Hoist',        zoneType: 'maintenance', cost: 300,  spriteColor: 0xddaa44, gridW: 4, gridH: 4, spriteKey: 'craneHoist',       effects: { zoneOutput: 0.10 } },
};

...
export const ZONES = {
  ...
  bathroom:    { id: 'bathroom',    name: 'Bathroom',       color: 0x4b8fb8, requiredFloor: 'terrazzoFloor', gatesCategory: null,         subsection: 'operations'   },
...
const ZONE_DESCS = {
  ...
  bathroom: 'A clean, tiled restroom for the people keeping the facility running. Paint over Terrazzo & Tile.',

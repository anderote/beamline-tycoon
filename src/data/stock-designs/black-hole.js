...
export const BLACK_HOLE_DESIGNS = [
  ...
  },
  {
    ...
    // Off-crest channeling stages keep the final energy below the 500 TeV
    // mission ceiling. Native measurements, including negligible delivered
    // current, are recorded in stock-designs.measured.json; an energy-band
    // pass does not establish a productive frontier-science machine.
    ...
    components: [
      ...
      { type: 'quadrupole', params: { gradient: 3.6, polarity: 0 } },
      { type: 'quadrupole', params: { gradient: 1.6, polarity: 1 } },
      { type: 'crystalChannelStage', params: { rfPhase: 8 } },
      { type: 'crystalChannelStage', params: { rfPhase: 8 } },
      { type: 'crystalChannelStage', params: { rfPhase: 8 } },
      { type: 'crystalChannelStage', params: { rfPhase: 8 } },
      { type: 'crystalChannelStage', params: { rfPhase: 8 } },

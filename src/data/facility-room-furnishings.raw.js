...
export const FACILITY_ROOM_FURNISHINGS_RAW = {
  ...
  waterCooler: {
    id: 'waterCooler', name: 'Water Cooler', zoneTypes: ['cafeteria', 'officeSpace', 'reception', 'storageRoom'],
  ...
  cafeteriaRefrigerator: {
    id: 'cafeteriaRefrigerator', name: 'Refrigerator', zoneTypes: ['cafeteria', 'storageRoom'],
  ...
  wasteStation: {
    id: 'wasteStation', name: 'Waste & Recycling Station', zoneTypes: ['cafeteria', 'reception', 'storageRoom'],
...
const ROOM_FURNISHING_DESCS = {
  ...
  waterCooler: 'Hydration station and facility rumor mill. Cafeteria, Office Space, Reception, or Storage Room.',
  cafeteriaRefrigerator: 'Cold storage for lunches, temperature-sensitive supplies, and increasingly stern labels. Cafeteria or Storage Room.',
  ...
  wasteStation: 'Side-by-side waste and recycling with optimistic labels. Cafeteria, Reception, or Storage Room.',

...
export const FACILITY_ROOM_FURNISHINGS_RAW = {
  ...
  beamlineDisplayCase: {
    id: 'beamlineDisplayCase', name: 'Beamline Model Display', zoneTypes: ['officeSpace', 'meetingRoom'],
  ...
  areaRug: {
    id: 'areaRug', name: 'Area Rug', zoneTypes: ['officeSpace', 'meetingRoom'],
  ...
  runnerRug: {
    id: 'runnerRug', name: 'Runner Rug', zoneTypes: ['officeSpace', 'meetingRoom'],
  ...
  cafeteriaRefrigerator: {
    id: 'cafeteriaRefrigerator', name: 'Cafeteria Refrigerator', zoneType: 'cafeteria',
  ...
  sinkCounter: {
    id: 'sinkCounter', name: 'Sink Counter', zoneType: 'cafeteria',
  ...
  condimentStation: {
    id: 'condimentStation', name: 'Condiment Station', zoneType: 'cafeteria',
  ...
  wasteStation: {
    id: 'wasteStation', name: 'Waste & Recycling Station', zoneType: 'cafeteria',
...
const ROOM_FURNISHING_DESCS = {
  ...
  beamlineDisplayCase: 'A miniature accelerator under glass for tours, proposals, and pointing at during reviews. Office Space or Meeting Room.',
  ...
  areaRug: 'A large low-profile rug that layers beneath furniture without blocking the room layout. Office Space or Meeting Room.',
  runnerRug: 'A narrow patterned runner for glazed corridors, office aisles, and meeting-room approaches. Office Space or Meeting Room.',
  ...
  cafeteriaRefrigerator: 'Cold storage for lunches labeled with increasingly stern notes. Cafeteria.',
  sinkCounter: 'Wash-up counter for mugs, trays, and one suspiciously permanent spoon. Cafeteria.',
  condimentStation: 'Napkins, cups, packets, and the good hot sauce. Cafeteria.',
  wasteStation: 'Side-by-side waste and recycling with optimistic labels. Cafeteria.',

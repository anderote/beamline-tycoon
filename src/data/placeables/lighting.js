...
const LIGHT_PROFILES = {
  ...
  floorLamp:      { sourceRadius: 0.11, shadowSoftness: 0.76, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'warmSteady', cookieProfile: 'soft' },
  arcFloorLamp:   { sourceRadius: 0.13, shadowSoftness: 0.72, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'warmSteady', cookieProfile: 'soft' },
  torchiere:      { sourceRadius: 0.14, shadowSoftness: 0.82, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'warmSteady', cookieProfile: 'soft' },
  bankerLamp:     { sourceRadius: 0.08, shadowSoftness: 0.76, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'warmSteady', cookieProfile: 'soft' },
  magnifierTaskLamp: { sourceRadius: 0.08, shadowSoftness: 0.68, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'fluorescent', cookieProfile: 'soft' },
  recessedDownlight: { sourceRadius: 0.13, shadowSoftness: 0.86, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'fluorescent', cookieProfile: 'soft' },
  ceilingBatten:  { sourceRadius: 0.18, shadowSoftness: 0.86, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'fluorescent', cookieProfile: 'panel' },
  emergencyCeilingLight: { sourceRadius: 0.09, shadowSoftness: 0.7, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'statusBlink', cookieProfile: 'soft' },
  pictureLight:   { sourceRadius: 0.09, shadowSoftness: 0.78, bloomProfile: 'soft', volumeProfile: 'wallWash', dynamicProfile: 'warmSteady', cookieProfile: 'soft' },
  klaxonStrobe:   { sourceRadius: 0.09, shadowSoftness: 0.58, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'statusBlink', cookieProfile: 'cage' },
  rotatingBeacon: { sourceRadius: 0.1, shadowSoftness: 0.62, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'statusBlink', cookieProfile: 'soft' },
  signalTower:    { sourceRadius: 0.08, shadowSoftness: 0.65, bloomProfile: 'soft', volumeProfile: 'none', dynamicProfile: 'statusBlink', cookieProfile: 'soft' },
  exitLight:      { sourceRadius: 0.08, shadowSoftness: 0.76, bloomProfile: 'soft', volumeProfile: 'wallWash', dynamicProfile: 'warmSteady', cookieProfile: 'panel' },
};

...
const DECORATION_DESCS = {
  ...
  utilityPole2Way: 'Compact 2×2 wood HV pole: two through-conductor insulators sit on one side at two levels, with one elevated tap for a pole-mount service transformer. All three terminals share one passive bus.',
  utilityPole: 'Full 4×4 wood HV distribution pole with four overhead insulator terminals and one elevated side tap for a pole-mount transformer on a shared passive bus. Each overhead terminal accepts two wire segments and tensions suspended spans.',

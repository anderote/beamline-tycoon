...
export const FACILITY_LAB_FURNISHINGS_RAW = {
  rfWorkbench:      {
    ...
    parts: [
      ...
      // Benchtop instrument boxes (colored, no texture) for visual flavor
      { name: 'scopeBox', x: -1.3, y: 1.52, z: -0.35, w: 0.7, h: 0.5, l: 0.55, color: 0x3a3e46 },
      { name: 'scopeScreen', x: -1.3, y: 1.65, z: -0.08, w: 0.55, h: 0.32, l: 0.02, color: 0x104018 },
      { name: 'sgBox',    x:  0.15, y: 1.52, z: -0.4,  w: 0.75, h: 0.35, l: 0.5, color: 0x5a5e68 },
      { name: 'sgLcd',    x:  0.0,  y: 1.68, z: -0.16, w: 0.35, h: 0.12, l: 0.02, color: 0x304020 },
      // Tool rack at right
      { name: 'toolRack', x: 1.4, y: 1.52, z: -0.45, w: 0.6, h: 0.4, l: 0.3, color: 0x8a6a3a },
    ],
  },
  oscilloscope:     { id: 'oscilloscope',      name: 'Oscilloscope',       zoneType: 'rfLab',       cost: { funding: 120 },  energyCost: 0.5, spriteColor: 0xc6bea8, gridW: 1, gridH: 1, subH: 1, visualSubW: 1.5, visualSubH: 1.0, visualSubL: 0.8, spriteKey: 'oscilloscope',     effects: { zoneOutput: 0.05 }, baseMaterial: 'metal_brushed', faces: { '+Z': { decal: 'oscilloscope_front' }, '-X': { decal: 'oscilloscope_side' }, '+X': { decal: 'oscilloscope_side' } } },
  signalGenerator:  { id: 'signalGenerator',   name: 'Signal Generator',   zoneType: 'rfLab',       cost: { funding: 200 },  energyCost: 0.8, spriteColor: 0x3a3e46, gridW: 1, gridH: 1, subH: 1, visualSubW: 1.6, visualSubH: 0.6, visualSubL: 0.9, spriteKey: 'signalGenerator',  effects: { zoneOutput: 0.06 }, baseMaterial: 'metal_dark',     faces: { '+Z': { decal: 'signal_generator_front' }, '-X': { decal: 'signal_generator_side' }, '+X': { decal: 'signal_generator_side' } } },
  spectrumAnalyzer: { id: 'spectrumAnalyzer',  name: 'Spectrum Analyzer',  zoneType: 'rfLab',       cost: { funding: 350 },  energyCost: 1.0, spriteColor: 0x888c94, gridW: 1, gridH: 1, subH: 1, visualSubW: 1.8, visualSubH: 1.2, visualSubL: 1.0, spriteKey: 'spectrumAnalyzer', effects: { zoneOutput: 0.08 }, baseMaterial: 'metal_brushed', faces: { '+Z': { decal: 'spectrum_analyzer_front' }, '-X': { decal: 'spectrum_analyzer_side' }, '+X': { decal: 'spectrum_analyzer_side' } } },
  networkAnalyzer:  { id: 'networkAnalyzer',   name: 'Network Analyzer',   zoneType: 'rfLab',       cost: { funding: 500 },  energyCost: 1.2, spriteColor: 0xd2c4a0, gridW: 1, gridH: 1, subH: 1, visualSubW: 2.0, visualSubH: 1.5, visualSubL: 1.2, spriteKey: 'networkAnalyzer',  effects: { zoneOutput: 0.10 }, baseMaterial: 'metal_brushed', faces: { '+Z': { decal: 'network_analyzer_front' }, '-X': { decal: 'network_analyzer_side' }, '+X': { decal: 'network_analyzer_side' } } },
  coolantPump:      { id: 'coolantPump',       name: 'Coolant Pump',       zoneType: 'coolingLab',  cost: { funding: 80 },   energyCost: 2.0, spriteColor: 0x33bbbb, gridW: 2, gridH: 2, subH: 2, spriteKey: 'coolantPump',      effects: { zoneOutput: 0.04 }, baseMaterial: 'metal_dark' },
  heatExchanger:    { id: 'heatExchanger',     name: 'Heat Exchanger',     zoneType: 'coolingLab',  cost: { funding: 150 },  energyCost: 3.0, spriteColor: 0x4499aa, gridW: 3, gridH: 2, subH: 2, spriteKey: 'heatExchanger',    effects: { zoneOutput: 0.06 }, baseMaterial: 'metal_dark' },
  pipeRack:         { id: 'pipeRack',          name: 'Pipe Rack',          zoneType: 'coolingLab',  cost: { funding: 40 },   energyCost: 0,   spriteColor: 0x667788, gridW: 1, gridH: 3, subH: 5, spriteKey: 'pipeRack',         effects: { zoneOutput: 0.02 }, baseMaterial: 'metal_brushed' },
  chillerUnit:      { id: 'chillerUnit',       name: 'Chiller Unit',       zoneType: 'coolingLab',  cost: { funding: 300 },  energyCost: 10.0, spriteColor: 0x2288aa, gridW: 4, gridH: 3, subH: 4, spriteKey: 'chillerUnit',      effects: { zoneOutput: 0.12 }, baseMaterial: 'metal_painted_white' },
  flowMeter:        { id: 'flowMeter',         name: 'Flow Meter',         zoneType: 'coolingLab',  cost: { funding: 100 },  energyCost: 0.1, spriteColor: 0x55cccc, gridW: 1, gridH: 1, subH: 1, visualSubW: 0.35, visualSubH: 0.4, visualSubL: 0.35, spriteKey: 'flowMeter',        effects: { zoneOutput: 0.03 }, baseMaterial: 'metal_dark' },
  testChamber:      { id: 'testChamber',       name: 'Test Chamber',       zoneType: 'vacuumLab',   cost: { funding: 200 },  energyCost: 4.0, spriteColor: 0x8855bb, gridW: 3, gridH: 3, subH: 2, spriteKey: 'testChamber',      effects: { zoneOutput: 0.08 }, baseMaterial: 'metal_brushed' },
  leakDetector:     { id: 'leakDetector',      name: 'Leak Detector',      zoneType: 'vacuumLab',   cost: { funding: 180 },  energyCost: 0.8, spriteColor: 0x6644aa, gridW: 2, gridH: 1, subH: 1, visualSubW: 1.3, visualSubH: 0.7, visualSubL: 0.75, spriteKey: 'leakDetector',     effects: { zoneOutput: 0.06 }, baseMaterial: 'metal_dark' },
  pumpCart:         { id: 'pumpCart',           name: 'Pump Cart',          zoneType: 'vacuumLab',   cost: { funding: 60 },   energyCost: 2.0, spriteColor: 0x9966cc, gridW: 2, gridH: 1, subH: 2, spriteKey: 'pumpCart',         effects: { zoneOutput: 0.02 }, baseMaterial: 'metal_dark' },
  gasManifold:      { id: 'gasManifold',       name: 'Gas Manifold',       zoneType: 'vacuumLab',   cost: { funding: 120 },  energyCost: 0.5, spriteColor: 0x7755aa, gridW: 3, gridH: 1, subH: 1, spriteKey: 'gasManifold',      effects: { zoneOutput: 0.04 }, baseMaterial: 'metal_brushed' },
  rga:              { id: 'rga',               name: 'Residual Gas Analyzer', zoneType: 'vacuumLab', cost: { funding: 400 },  energyCost: 2.5, spriteColor: 0xaa77dd, gridW: 1, gridH: 2, subH: 2, spriteKey: 'rga',              effects: { zoneOutput: 0.10 }, baseMaterial: 'metal_dark' },
  ...
  assemblyCrane:    { id: 'assemblyCrane',     name: 'Assembly Crane',     zoneType: 'machineShop', cost: { funding: 400 },  energyCost: 12.0, spriteColor: 0xddaa44, gridW: 4, gridH: 4, subH: 5, spriteKey: 'assemblyCrane',    effects: { zoneOutput: 0.12 }, baseMaterial: 'metal_brushed' },
  opticalTable: {
    id: 'opticalTable', name: 'Optical Table', zoneType: 'opticsLab',
    cost: { funding: 250 }, energyCost: 0.5, spriteColor: 0x2a2c34,
  ...
  laserAlignment:   { id: 'laserAlignment',    name: 'Laser Alignment System',  zoneType: 'opticsLab', cost: { funding: 400 },  energyCost: 2.0, spriteColor: 0xcc4444, gridW: 4, gridH: 1, subH: 2, spriteKey: 'laserAlignment',   effects: { zoneOutput: 0.10, beamPhysics: { emittanceReduction: 0.02 } }, baseMaterial: 'metal_dark' },
  mirrorMount:      { id: 'mirrorMount',       name: 'Mirror Mount Station',    zoneType: 'opticsLab', cost: { funding: 150 },  energyCost: 0.1, spriteColor: 0xaaaacc, gridW: 1, gridH: 1, subH: 1, visualSubW: 0.3, visualSubH: 0.6, visualSubL: 0.3, spriteKey: 'mirrorMount',      effects: { zoneOutput: 0.04 }, baseMaterial: 'metal_brushed' },
  beamProfiler:     { id: 'beamProfiler',      name: 'Beam Profiler',           zoneType: 'opticsLab', cost: { funding: 300 },  energyCost: 1.0, spriteColor: 0x44cc88, gridW: 2, gridH: 1, subH: 1, visualSubW: 1.3, visualSubH: 0.5, visualSubL: 0.7, spriteKey: 'beamProfiler',     effects: { zoneOutput: 0.07, beamPhysics: { diagnosticAccuracy: 0.05 } }, baseMaterial: 'metal_dark' },
  interferometer:   { id: 'interferometer',     name: 'Interferometer',          zoneType: 'opticsLab', cost: { funding: 500 },  energyCost: 1.5, spriteColor: 0x8844cc, gridW: 2, gridH: 2, subH: 2, spriteKey: 'interferometer',   effects: { zoneOutput: 0.12 }, baseMaterial: 'metal_brushed' },
  scopeStation:     { id: 'scopeStation',      name: 'Scope Station',           zoneType: 'diagnosticsLab', cost: { funding: 100 },  energyCost: 0.2, spriteColor: 0x44aa44, gridW: 1, gridH: 1, subH: 2, visualSubW: 0.9, visualSubH: 1.8, visualSubL: 0.9, spriteKey: 'scopeStation',     effects: { zoneOutput: 0.03 }, baseMaterial: 'metal_painted_white' },
  wireScannerBench: { id: 'wireScannerBench',  name: 'Wire Scanner Bench',      zoneType: 'diagnosticsLab', cost: { funding: 200 },  energyCost: 1.5, spriteColor: 0x888888, gridW: 4, gridH: 2, subH: 2, spriteKey: 'wireScannerBench', effects: { zoneOutput: 0.06 }, baseMaterial: 'metal_brushed' },
  bpmTestFixture:   { id: 'bpmTestFixture',    name: 'BPM Test Fixture',        zoneType: 'diagnosticsLab', cost: { funding: 300 },  energyCost: 1.0, spriteColor: 0xcccc44, gridW: 2, gridH: 2, subH: 2, spriteKey: 'bpmTestFixture',   effects: { zoneOutput: 0.08 }, baseMaterial: 'metal_dark' },
  daqRack: {
    ...
    // 1×2 footprint, 2.5 m tall. 19" rack frame with a few big DAQ
    // chassis, a patch panel, a UPS, and status LEDs up top.
    parts: [
      // Plinth + top cap
      ...
      // Big 4U DAQ chassis (grey, label strip)
      ...
      { name: 'daq1Led1', x: -0.25, y: 0.72, z: -0.97, w: 0.05, h: 0.05, l: 0.02, color: 0x44ff66 },
      { name: 'daq1Led2', x: -0.15, y: 0.72, z: -0.97, w: 0.05, h: 0.05, l: 0.02, color: 0xffaa40 },
      // 6U oscilloscope-style unit
      { name: 'daq2',     x: 0, y: 1.2, z: -0.02, w: 0.82, h: 1.0, l: 1.9, color: 0x3a3c42 },
      { name: 'daq2Scr',  x: 0, y: 1.5, z: -0.95, w: 0.55, h: 0.5, l: 0.02, color: 0x0a2a14 },
      // Patch panel
      { name: 'patch',    x: 0, y: 2.3, z: -0.02, w: 0.82, h: 0.35, l: 1.9, color: 0x2c2e34 },
      // Server/controller unit
      { name: 'ctrl',     x: 0, y: 2.75, z: -0.02, w: 0.82, h: 0.6, l: 1.9, color: 0x48484c },
      { name: 'ctrlLed',  x: -0.2, y: 2.95, z: -0.97, w: 0.04, h: 0.04, l: 0.02, color: 0x44ff66 },
      // UPS (heavy, bottom-heavy orange)
      { name: 'ups',      x: 0, y: 3.45, z: -0.02, w: 0.82, h: 0.9, l: 1.9, color: 0x4a4a52 },
      { name: 'upsLcd',   x: 0, y: 3.75, z: -0.95, w: 0.35, h: 0.2, l: 0.02, color: 0xd0b840 },
      // Status lamps cluster at top
      { name: 'lampArea', x: 0, y: 4.45, z: -0.02, w: 0.82, h: 0.35, l: 1.9, color: 0x2a2a30 },
      { name: 'lamp1',    x: -0.25, y: 4.58, z: -0.97, w: 0.06, h: 0.06, l: 0.02, color: 0x44ff66 },
      { name: 'lamp2',    x: -0.1,  y: 4.58, z: -0.97, w: 0.06, h: 0.06, l: 0.02, color: 0xffaa40 },
      { name: 'lamp3',    x:  0.05, y: 4.58, z: -0.97, w: 0.06, h: 0.06, l: 0.02, color: 0xff4040 },
    ],
  },
  serverCluster:    { id: 'serverCluster',     name: 'Server Cluster',          zoneType: 'diagnosticsLab', cost: { funding: 500 },  energyCost: 5.0, spriteColor: 0x448844, gridW: 3, gridH: 2, subH: 5, spriteKey: 'serverCluster',    effects: { research: 0.08 }, baseMaterial: 'metal_dark' },
  ...
  craneHoist:       { id: 'craneHoist',        name: 'Crane Hoist',        zoneType: 'maintenance', cost: { funding: 300 },  energyCost: 12.0, spriteColor: 0xddaa44, gridW: 4, gridH: 4, subH: 5, spriteKey: 'craneHoist',       effects: { zoneOutput: 0.10 }, baseMaterial: 'metal_brushed' },
};

...
export const INFRASTRUCTURE_RAW = {
  ...
  vacuumCart: {
    ...
    desc: 'A wheeled pump-down station with two dry roughing pumps backing one turbomolecular pump. The complete stack is already manifolded and controlled, so one hookup can take a chamber from atmosphere into high vacuum without assembling three separate machines. Delivers 330 L/s through Vacuum Pipe.',
    category: 'vacuum', subsection: 'supply',
    cost: { funding: 475000 },
    stats: {},
    energyCost: 3,

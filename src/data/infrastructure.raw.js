...
export const INFRASTRUCTURE_RAW = {
  ...
  hvTransformer: {
    ...
    category: 'power', subsection: 'supply',
    cost: { funding: 800000 },
    stats: {},
    energyCost: 0,
    powerCapacity: 1200,
  ...
  switchgear: {
    ...
    desc: 'Outdoor metal-clad switchgear housing circuit breakers and bus bars. Distributes power from the HV transformer to your facility buildings. Place next to transformers in your switchyard.',
    category: 'power', subsection: 'supply',
    cost: { funding: 400000 },
    stats: {},
    energyCost: 0,

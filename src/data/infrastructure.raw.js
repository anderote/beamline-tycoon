...
export const INFRASTRUCTURE_RAW = {
  ...
  powerPanel: {
    ...
    desc: 'Local power distribution panel with a 40 kW branch circuit — enough for diagnostics, small pumps, and electronics. Place along the beamline to provide Power Cable connection points. The cheapest way to power a network, but real loads need a transformer.',
  ...
  powerBus: {
    ...
    desc: 'Overhead low-voltage busway with plug-in tap boxes that energizes every magnet, cavity and instrument within reach on one beamline segment. Feed it from one panel circuit; it distributes that one circuit and never generates capacity.',
  ...
  spiderBox: {
    id: 'spiderBox',
    name: 'Spider Box',
    desc: 'Compact field distribution box. One incoming branch circuit fans to four local equipment connections without adding capacity. Use it for a small cluster that does not justify a full beamline busway.',
    category: 'power', subsection: 'fieldDistribution',
    cost: { funding: 18000 },
    stats: {},
    energyCost: 0,
    subL: 2, subW: 2, subH: 1, gridW: 2, gridH: 2, geometryType: 'box',
    baseMaterial: 'metal_painted_green',
    spriteKey: 'powerPanel',
    spriteColor: 0x8a8f96,
    accentColor: 0x8a8f96,

...
export const INFRASTRUCTURE_RAW = {
  ...
  meterMain: {
    ...
    parts: [
      { w: 0.86, h: 1.55, l: 0.18, x: 0, y: 1.55, z: 0.58, color: 0x435a48 },
      { w: 0.86, h: 1.55, l: 0.18, x: 0, y: 1.55, z: -0.58, color: 0x435a48 },
      { w: 0.58, h: 0.84, l: 1.22, x: 0, y: 2.08, z: 0, color: 0x262d28 },
      { w: 0.42, h: 0.58, l: 0.08, x: -0.24, y: 2.30, z: 0.70, color: 0xd8e7d7 },
      { w: 0.36, h: 0.18, l: 0.08, x: 0.28, y: 2.43, z: 0.70, color: 0x79d58a },
    ],
    requiredConnections: [],
  },
  hvWallPassThrough: {
  ...
  gridServicePoint: {
    id: 'gridServicePoint',
    name: 'Utility Service Pole — 3 MW',
    desc: 'A normal 4×4 wood utility pole that represents a 3 MW connection to the off-map grid. Place it within four tiles of the property boundary. Four incoming HV conductors run from the map edge to its real crossarm terminals; each terminal accepts one player-drawn feeder into the facility.',
    ...
    energyCost: 0,
    powerCapacity: 3000,
    // Same footprint and silhouette as the ordinary 4×4 wood utility pole.
    subL: 2, subW: 2, subH: 16, gridW: 2, gridH: 2,
    geometryType: 'box',
    baseMaterial: 'metal_dark',
    spriteKey: 'utility_pole',
    spriteColor: 0x75512f,
    accentColor: 0x667078,
    hasSurface: false,
  ...
  gridServicePointHighCapacity: {
    ...
    name: 'Utility Transmission Tower — 6 MW',
    desc: 'A normal 6×6 HV transmission tower that represents two three-phase circuits from the off-map grid. Place it within four tiles of the property boundary. Six incoming conductors run from the map edge to its real hanging-insulator terminals; each terminal accepts one player-drawn feeder into the facility.',
    category: 'power', subsection: 'gridSupply',
    paletteOrder: 20,
    ...
    energyCost: 0,
    powerCapacity: 6000,
    // Same footprint and silhouette as the ordinary 6×6 transmission tower.
    subL: 4, subW: 4, subH: 18, gridW: 4, gridH: 4,
    geometryType: 'box',
    baseMaterial: 'metal_dark',
    spriteKey: 'utility_pole',
    spriteColor: 0x707980,
    accentColor: 0x41494f,
    hasSurface: false,
    hvCableSupport: 'outdoorPole',
    placement: 'module',
    mapEdgeConnection: {
      ...
      // off-map grid and land on the same six terminals used by player cables.
      conductorCount: 6,
      leadHeightMeters: 6.0,
    ...
    electricalControl: {
      source: { kind: 'grid', outageChancePerTick: 0.00055, outageMinTicks: 12, outageMaxTicks: 35 },
      breaker: { utility: 'hvCable', rating: 6000, tripDelayTicks: 5 },
    },
    requiredConnections: [],
  },
  powerPanel: {
  ...
  sectionDistributionPanel: {
    ...
    desc: 'A 600 kW green distribution panel for a beamline section or service bay. A two-connection tensioned roof terminal taps the HV trunk into six 50 kW branch circuits and one protected 300 kW HV feeder.',
    category: 'power', subsection: 'distribution',
    paletteOrder: 20,
    cost: { funding: 180000 },
    stats: {},
    ...
    ports: {},
    electricalControl: {
      breaker: { utility: 'powerCable', rating: 600, tripDelayTicks: 5 },
    },
    requiredConnections: [],
  },
  mainDistributionPanel: {
    ...
    desc: 'A 1,200 kW green main distribution panel for a major beamline hall. A two-connection tensioned roof terminal taps the HV trunk into twelve 50 kW branch circuits and two protected 300 kW HV feeders.',
    category: 'power', subsection: 'distribution',
    paletteOrder: 30,
    cost: { funding: 480000 },
    stats: {},
    ...
    ports: {},
    electricalControl: {
      breaker: { utility: 'powerCable', rating: 1200, tripDelayTicks: 5 },
    },
    requiredConnections: [],
  },
  hvTransformer: {
    id: 'hvTransformer',
    name: 'HV Transformer',
    desc: 'Oil-filled high-voltage power transformer fed from a Utility Service Point. The 1.5 MW unit provides four protected HV feeder outlets and anchors a serious facility. Place outdoors in a switchyard with disconnect switches and switchgear for an authentic substation layout.',
  ...
  gridIntertieTransformer: {
    ...
    desc: 'Large utility intertie transformer fed from the 6 MW Utility Service Point. Provides 6000 kW through six protected HV feeder outlets for several independently distributed accelerator halls.',
    category: 'power', subsection: 'transformers',
    paletteOrder: 40,

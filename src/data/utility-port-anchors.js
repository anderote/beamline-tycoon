...
export const PORT_ANCHOR_OVERRIDES = {
  ...
  coldWaterLineWallPassThrough: {
    _default: { y: 0.05, lat: 0.10, along: -0.06, out: 0.04 },
  },
  ...
  dualCircuitChiller: {
    ...
    return_hot_in: { along: -0.25 }, supply_cold_out: { along: 0.25 },
    room_in: { along: -0.25, lat: 0.735 },
    reject_hot_out: { along: 0.25, lat: 0.735 },
  },
  chiller: {
    ...
    return_hot_in: { along: -0.35 }, supply_cold_out: { along: 0.35 },
    room_in: { along: -0.24, lat: 0.985 },
    reject_hot_out: { along: 0.24, lat: 0.985 },
  },
  fanCoilCooler: {

  ...
  roof: {
    ...
    roofProfiles: {
      dropCeiling: {
        id: 'dropCeiling',
        height: 2.68,
        texture: 'ceiling_acoustic_tile',
      },
      highBay: {
        id: 'highBay',
        height: 3.35,
        texture: 'ceiling_highbay',
      },
    },
  },
  labFloor: {
...
export const STRUCTURE_WALLS = {
  ...
  labWall: {
    ...
    desc: 'Sealed, washable panel wall for laboratories, clean assembly rooms, and instrument spaces.',
    cost: 22,
    color: 0xd8e1e4,
    topColor: 0xecf1f2,
    subH: 6,
...
// Door types — placed on tile edges. Ordinary doors occupy one edge; authored
// `tileSpan` doors are one atomic opening across that many consecutive edges.
export const DOOR_TYPES = {
  hangarDoor3: {
    id: 'hangarDoor3',
    name: '3×1 Hangar Blast Door',
    desc: 'A three-bay bi-parting steel door for vehicle access, service halls, and compact experimental bays.',
    cost: 320,
    color: 0x59636b,
    topColor: 0x7c8991,
    subH: 8,
    ...
    subsection: 'exterior',
    isDoor: true,
    variants: ['Galvanized Steel', 'Dark Steel', 'Safety Yellow'],
    variantPreviewColors: [0x8d989f, 0x465159, 0xd3ad3f],
    variantTints: [0xaeb8bd, 0x56636c, 0xe0ba42],
  },
  hangarDoor4: {
    id: 'hangarDoor4',
    name: '4×1 Hangar Blast Door',
    desc: 'A four-bay bi-parting blast door for accelerator halls and heavy equipment access.',
    cost: 520,
    color: 0x59636b,
    topColor: 0x7c8991,
    subH: 8,
  ...
  hangarDoor6: {
    id: 'hangarDoor6',
    name: '6×1 Hangar Blast Door',
    desc: 'A six-bay bi-parting hangar door for the largest assembly halls and transport routes.',
    cost: 860,
    color: 0x59636b,
    topColor: 0x7c8991,
    subH: 8,
